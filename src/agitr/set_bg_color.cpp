// This program waits for a turtlesim to startup and changes it's background color
#include <ros/ros.h>
...
int main(int argc, char **argv)
{
    ...
    // indicates that the thrutlesim has started up, and has
    // set the background color parameters.
    ros::service::waitForService("clear");

    // Set the background color turtlesim,
