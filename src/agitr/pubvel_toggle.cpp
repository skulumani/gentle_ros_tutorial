// This program toggles between rotation and translation commands,
// based on the calls to a service
#include <ros/ros.h>
...
int main(int argc, char **argv)
{
    ...
    // Publish commands, using the latest value for forward, until the node is shutdown
